...
<head>
    ...
    <title>The AnomalieZ -Analyse Using HMM</title>
    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="nav notify-row" id="top_menu">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="active-trail active" href="/hmm_file_upload">My files</a>
                </li>
                <li>
                    <a class="current" href="">Analyse using HMM</a>
                </li>
            </ul>
        </div>
...
<script src="../../resources/js/c3-chart-HMMAnalysis-init.js"></script>
