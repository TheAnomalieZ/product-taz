...
<head>
    ...
    <title>The AnomalieZ -Analyse Using Auto Encoder</title>
    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="nav notify-row" id="top_menu">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="active-trail active" href="/ae_file_upload">My files</a>
                </li>
                <li>
                    <a class="current" href="">Analyse using auto encoder</a>
                </li>
            </ul>
        </div>
                     ...
                     <span class="tools pull-right">
                        ...
                        <div class="panel-body">
                            <c:forEach var="region" items="${hotMethods}">
                                <button type="button" data-toggle="tab" href="#regin_${region.regionID}"
                                        onclick="zoomGraph(${region.startGCId}, ${region.endGCId})"
...
<script src="../../resources/js/c3-chart-AEAnalysis-init.js"></script>
