    ...
    <div class="nav notify-row" id="top_menu">
      <ul class="breadcrumbs-alt">
        ...
        <%--</li>--%>
          ...
          <%--<li>--%>
          <%--<a class="active-trail active" href="#">My Files</a>--%>
          <%--</li>--%>
          <li>
            <a class="current" href="">My Files</a>
          </li>
      </ul>
    </div>
  </header>
...
<script type="text/javascript">
  ...
  function deleteFile(fileName) {
    $.ajax({
      type: 'GET',
      url: 'train_file_hmm/deleteFile?fileName=' + fileName,
      success: function (data) {
  ...
  function train(fileName) {
    $.ajax({
      type: 'GET',
      url: 'train_file_hmm/hmm_train?fileName=' + fileName,
      success: function (data) {
        console.log("Successfully deleted");
        deleteFile(fileName);
        location.reload(true);
