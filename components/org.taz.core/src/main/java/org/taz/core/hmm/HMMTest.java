...
public class HMMTest {
    public static void main(String[] args) {
        ...
        ArrayList<Double> scorelist  = hmm.generateScoreSeries("/home/suve/FYP/HMMLast/App1/anomaly_validation_2.jfr","App2");
        ...
        ArrayList<Double []> anomalyregion = hmm.getAnomlayTimes(labels, 30);
