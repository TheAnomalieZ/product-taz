...
f = open('../anomaly_scores/heap_duration_20170223_232014.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
    ...
    f.close()
scorelist = floats
labellist = labeling(732,933, scorelist)
labellist = labeling(1805,2067, scorelist)
labellist = labeling(2975,3165, scorelist)
labellist = labeling(4435,4730, scorelist)
labellist = labeling(5778,5874, scorelist)
labellist = labeling(7138,7305, scorelist)
labellist = labeling(8342,8605, scorelist)

# labellist = labeling(202,299, scorelist)
# labellist = labeling(563,688, scorelist)
# labellist = labeling(847,981, scorelist)
...
f = open('../anomaly_scores/heap_duration_gap_20170223_232243.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_duration_meta_20170223_232142.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_duration_old_20170223_231935.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_duration_old_gap_20170223_232213.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_duration_old_meta_20170223_231848.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_meta_20170223_232117.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
...
f = open('../anomaly_scores/heap_old_20170223_232056.csv')
try:
    reader = csv.reader(f)
    floats = []
    for row in reader:
